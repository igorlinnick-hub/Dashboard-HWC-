    ...
    <div className="relative flex min-h-screen items-center justify-center bg-surface overflow-hidden">
      ...
      <div className="relative w-full max-w-[400px] px-4 animate-fade-in">
        <div className="mb-10 text-center">
          ...
          <p className="mt-1.5 text-sm text-text-muted">Get started with your agency dashboard</p>
        </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-surface-border bg-surface-card shadow-2xl shadow-black/40">
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              <div>
                <label htmlFor="email" className="mb-1.5 block text-[13px] font-medium text-text-secondary">Email</label>
              ...
              <div>
                <label htmlFor="password" className="mb-1.5 block text-[13px] font-medium text-text-secondary">Password</label>
              ...
              <div>
                <label htmlFor="confirmPassword" className="mb-1.5 block text-[13px] font-medium text-text-secondary">Confirm Password</label>
